    ...
    <div className="container mt-5">
      ...
      <div className="row">
        {[
          ...
          { title: "Livraisons par Produit", key: "produitsLesPlusLivres", headers: ["Produit", "Total des Livraisons"] },
          { title: "Chauffeurs les Plus Fréquents", key: "chauffeursLesPlusUtilises", headers: ["Chauffeur", "Total des Livraisons"] },
          { title: "Camions les Plus Utilisés", key: "camionsLesPlusUtilises", headers: ["Camion (Matricule)", "Total des Livraisons"] },
          { title: "Produit les Plus Livré", key: "produitsLesPlusLivres", headers: ["Produit", "Total des Livraisons"] },
